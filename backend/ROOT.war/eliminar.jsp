<%@ page import="java.sql.*, com.mongodb.MongoClient, com.mongodb.client.model.Filters" %>
...
<%
    ...
    try {
        ...
        ps.setInt(1, Integer.parseInt(id)); ps.executeUpdate(); con.close();

        MongoClient mc = new MongoClient("mongodb", 27017);
        mc.getDatabase("hardware_db").getCollection("equipos").deleteOne(Filters.eq("id_maquina", Integer.parseInt(id))); mc.close();
